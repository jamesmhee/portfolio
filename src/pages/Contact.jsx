...
const Contact = () => {
  ...
  return (
    <>
      <footer
        id="contact"
        className="h-fit flex items-end justify-center bg-footer bg-top md:bg-bottom bg-cover"
      >
        <div className="flex flex-col gap-10 my-20 items-center text-slate-900 ">
          <div className="flex">
            <div className="w-90 sm:w-[380px] lg:w-[1000px] md:w-[700px] text-center md:max-w-[1000px] p-5 md:p-10 h-auto bg-white drop-shadow-lg rounded-[50px]">
              <h1 className="text-[2rem] text-rose-600 uppercase text-center md:text-right font-semibold text-shadow-lg p-5">
                Contact me
              </h1>
              <form
                id="form"
                name="Form"
                className="flex flex-col p-5 space-y-6"
                ref={form}
                onSubmit={sendEmail}
              >
                <input
                  className="bg-white focus:transition-all rounded text-rose-600 p-2 border-2 rounded-[30px] drop-shadow-md caret-rose-600"
                  required
                ...
                />
                <textarea
                  className="resize-none bg-white focus:transition-all rounded text-rose-600 p-2 border-2 rounded-[30px] drop-shadow-md caret-rose-600 "
                  required
                ...
                <button
                  ...
                  className="rounded-[20px] h-20 w-60 mx-auto drop-shadow-lg shadow-orange-800 mt-10 text-white bg-rose-600 text-[1.8rem] hover:text-slate-100 hover:bg-black transition-all duration-300"
                  type="submit"
                >
                  {sending ? (
                    <p className="text-current transition-all duration-500 text-center underline inline-flex text-[1.6rem] ">
                      SENDING&nbsp;
          ...
          <div className="flex gap-10 mb-10">
            ...
            >
              <h2 className="text-[1.25rem] cursor-pointer duration-500 text-slate-100 hover:text-rose-600 mt-10">
                <MdEmail className="inline-flex" size={20} /> :
                nontasabs@gmail.com
              </h2>
            </Link>
          </div>
